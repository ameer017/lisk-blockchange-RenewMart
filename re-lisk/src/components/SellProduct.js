...
//             }
//         } catch (e) {
//             console.log("error uploading JSON Metadat", e)
//         }
//     }
...
//             // Validate formParams.price
//             const price = parseFloat(formParams.price);
//             if (isNaN(price) || price <= 0) {
//                 throw new Error("Invalid price. Please enter a valid price greater than 0.");
//             }
...
//             let transaction = await contract.createToken(metadataURL, priceInEther, {value: listingPrice});
//             await transaction.wait();
