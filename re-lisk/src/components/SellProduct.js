...
export default function SellProduct () {
    ...
    //This function uploads the product image to IPFS
    ...
    return (
        ...
        <Navbar></Navbar>
        <div className="flex flex-col place-items-center mt-10" id="productForm">
            ...
            <h3 className="text-center font-bold text-purple-500 mb-8">Upload your Product to the marketplace</h3>
                ...
                <button onClick={sellProduct} className="font-bold mt-10 w-full bg-purple-500 text-white rounded p-2 shadow-lg" id="list-button">
                    List Product
                </button>
            </form>
        </div>
