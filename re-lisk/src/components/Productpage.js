...
async function buyproduct(tokenId) {
    ...
    return(
        <div style={{"min-height":"100vh"}}>
            <Navbar></Navbar>
            <div className="flex items-center justify-center flex-col md:flex-row mt-[5rem] gap-6 ">
                <img src={data.image} alt="" className="w-[250px] md:w-[400px] " />
                <div className="text-xl mt-[10px] space-y-8 text-white shadow-2xl rounded-lg md:border-2 p-5">
                    <div>
                        Name: {data.name}
                    </div>
                    <div>
                    ...
                    { currAddress !== data.owner && currAddress !== data.seller ?
                        <button className="enableEthereumButton bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded text-sm" onClick={() => buyproduct(tokenId)}>Buy Now</button>
