...
import "@openzeppelin/contracts/token/ERC721/ERC721.sol";
 ...
 contract ReCommerce is ERC721URIStorage {
    ...
    function getAllProducts() public view returns(ListedToken[] memory) {
        uint productCount = _tokenIds.current();
        ListedToken[] memory tokens = new ListedToken[](productCount);
    ...
    function getMyProduct() public view returns(ListedToken [] memory) {
